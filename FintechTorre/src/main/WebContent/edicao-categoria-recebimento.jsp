...
<body>
	...
	<div class="container">
		...
		<form action="categoria-recebimento" method="post">
			...
			<input type="hidden" value="${categoria.cdCategoriaRecebimento }" name="codigo">
			
			<div class="form-group">
				<label for="nome-categoria-recebimento">Nome da Categoria</label> <input
					type="text" name="nome" id="nome"
					class="form-control" value="${categoria.nomeCategoriaRecebimento }">
			</div>
			<br>
			<div class="form-group">
				<label for="ds-categoria">Descrição</label> <input
					type="text" name="descricao" id="descricao"
					class="form-control" value="${categoria.descricaoRecebimento }">
			</div>
			<br>
			<input type="submit" value= "Salvar" class= "btn btn-outline-dark" >
			<a href="categoria-recebimento?acao=listar" class="btn btn-danger">Cancelar</a>
		</form>
	</div>
